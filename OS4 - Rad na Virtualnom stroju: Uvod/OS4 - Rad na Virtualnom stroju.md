...
<img src="./screenshots/vmw-virtualization-defined.jpg" style="width:50%;" ></img>
...
<img src="./screenshots/virtual-machine-hypervisor.png" style="width:40%;" ></img>
...
<img src="./screenshots/virtualbox-logo.webp" style="width:20%;" ></img>
...
<img src="./screenshots/windows-taskmanager-virtualisation.png" style="width:40%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server.png" style="width:30%; border-radius: 10px;" ></img>
...
<img src="./screenshots/virtualbox/new-vm.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/virtualbox/ram-cpu-setup.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/virtualbox/summary.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/try-or-install-ubuntu-server.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/ubuntu-server-base.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/profile-config.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/installing.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/successfull-login-ubuntu-server.png" style="width:70%;" ></img>
...
<img src="./screenshots/vm-illustrations/vm-illustration_1.png" style="width:50%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/root-dir-lsla.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/apt.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/ls-la-ubuntu-sources.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/index-of-ubuntu-ports.png" style="width:40%;" ></img>
...
<img src="./screenshots/ubuntu-server/sudo-apt-update.png" style="width:50%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/upgrade-then-update-again.png" style="width:90%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/sudo-apt-install-nanovim.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/SSH_simplified_protocol_diagram-2.webp" style="width:70%;" ></img>

> 🖼️ Ilustracija SSH protokola - https://www.ssh.com/academy/ssh

### 3.2.1 Instalacija OpenSSH poslužitelja

<img src="./screenshots/openssh.gif" style="width:70%;" ></img>
...
<img src="./screenshots/ubuntu-server/systemctl-status-ssh.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/sudo-system-start-ssh.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/lsof-i-22.png" style="width:60%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/ip-address.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/virtualbox/port-forwarding.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/ss-tuln.png" style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/virtualbox/port-forwarding-adding-entry.png"  style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/host-ssh-successful-connect.png"  style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/ip-addr-bridged-adapter.png"  style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/ubuntu-server/ssh-successfull-connection-bridged.png"  style="width:70%; border-radius: 10px;" ></img>
...
<img src="./screenshots/vm-illustrations/vm-illustration_2.png"  style="width:50%; border-radius: 10px;" ></img>
...
<img src="./screenshots/vm-illustrations/vm-illustration_3.png"  style="width:40%; border-radius: 10px;" ></img>
